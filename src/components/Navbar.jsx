...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { href: "#testimonials", label: "Client's Review" },
  ]
    ...
    >
      <div className="w-full flex justify-between items-center container mx-auto px-4 sm:px-6 lg:px-8 md:h-20 h-16">
        ...
        >
          ...
          <img 
          src='../src/assets/icons8-laptop-50.png'
          alt='logo'
          className='w-8 h-8 hover:opacity-90 transition-opacity'
          />
          <span className="text-xl font-medium ml-2 z-100">The Next Design</span>
          </div>
           </motion.div>
        </motion.div>
        {/* Mobile Menu Button */}
