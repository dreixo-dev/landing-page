      ...
      <div className="section-container">
          ...
          >
            ...
            >
              ...
              <img 
                ...
                alt="The Next Design Logo" 
                className="w-6 h-6"
              />
              <span className="text-xl font-medium ml-2">The Next Design</span>
            </div>
            </motion.div>
            <motion.p 
        ...
        >
          ...
          >
            ...
            >
              Copyright © {new Date().getFullYear()} dreixo-dev
            </motion.p>
            <motion.p 
              variants={fadeIn('left', 1.0)}
              className="text-gray-600 text-sm"
            >
              Created by Andrei Almoguerra
            </motion.p>
          </motion.div>
        </motion.div>
      </div>
