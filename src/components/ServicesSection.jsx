  ...
  const services = [
    {
      ...
      description: "Build and maintain websites and web applications using languages",
      link: "#learn-more"
    },
    {
      icon: <AiOutlineAntDesign className="w-8 h-8 text-amber-400" />,
      title: "UX Design", 
      description: "focuses on creating a seamless and compelling experience",
      link: "#learn-more"
    },
    {
      icon: <FiSettings className="w-8 h-8 text-red-400" />,
      title: "Automation",
      description: "To perform tasks with minimal human intervention",
      link: "#learn-more"
    },
    {
      icon: <BiTime className="w-8 h-8 text-cyan-400" />,
      title: "Infographics",
      description: "Visual representations of information designed to present complex data or ideas",
      link: "#learn-more"
    }
  ]
